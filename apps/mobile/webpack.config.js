...
module.exports = async function (env, argv) {
  ...
  config.resolve.alias = {
    ...(config.resolve.alias || {}),
    // Provide a web shim for react-native-webview used by some native-only libs
    'react-native-webview': path.resolve(__dirname, 'src/shims/react-native-webview.js'),
